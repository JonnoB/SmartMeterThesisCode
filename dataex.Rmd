...
```{r}
packages <-c("stringr", "lubridate", "data.table","caret", "xgboost", "R.utils", "corrplot", "Hmisc", "Amelia", "Matrix", "ff", "ggdendro", "zoo", "igraph","parallel","dplyr", "magrittr", "ggplot2", "tidyr", "xtable")
